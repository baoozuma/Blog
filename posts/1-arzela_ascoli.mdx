...
thumbnail: "/thumbnails/arzela.jpg"
tags: ['Functional Analysis', 'Classical Analysis']
---
...
<Theorem label="Arzelà–Ascoli">
Let $K$ be a compact metric space and $\mathcal{F} \subset C(K)$ a family of continuous functions. If $\mathcal{F}$ is:
 
- **uniformly bounded**: $\sup_{f \in \mathcal{F}} \|f\|_\infty < \infty$
- **equicontinuous**: for every $\varepsilon > 0$ there exists $\delta_\varepsilon > 0$ such that $d(x,y) < \delta_\varepsilon\Rightarrow |f(x) - f(y)| < \varepsilon$ for all $f \in \mathcal{F}$
