...
tags: ['Classical Analysis', 'Functional Analysis']
---

## Approach

<Lemma>
Let $K$ be a compact metric space and $(E,\|\cdot\|)$ be a Banach space. Then the space $C(K,E)$ equipped with a supremum norm $\|f\|_{\infty} = \sup_{x \in K}\|f(x)\|$ is a Banach space.
</Lemma>
...
<Theorem label="Grönwall Inequality">
